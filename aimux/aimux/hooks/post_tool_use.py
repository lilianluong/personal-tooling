#!/usr/bin/env python3
"""Claude Code PostToolUse hook — marks session as active when Claude resumes after user input.

Fires after AskUserQuestion (inline Q&A) and ExitPlanMode (plan approval).
